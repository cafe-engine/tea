...
impl GlEnum for PixelFormat {
    fn to_enum(&self) -> u32 {
        match self {
            PixelFormat::Alpha => { return gl::RED },
            PixelFormat::LuminanceAlpha => { return gl::RG },
...
impl GlEnum for TexParam {
    fn to_enum(&self) -> u32 {
        match self {
            Self::TexFilterMin(_) => { gl::TEXTURE_MIN_FILTER },
            Self::TexFilterMag(_) => { gl::TEXTURE_MAG_FILTER },
            Self::TexWrapS(_) => { gl::TEXTURE_WRAP_S },
            Self::TexWrapT(_) => { gl::TEXTURE_WRAP_T }
            Self::TexWrapR(_) => { gl::TEXTURE_WRAP_R }
        }
    }
}
